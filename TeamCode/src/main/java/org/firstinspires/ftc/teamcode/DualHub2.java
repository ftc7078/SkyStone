...
@TeleOp(name="DualHub2", group="Linear Opmode")

public class DualHub2 extends LinearOpMode {
    ...
    private final double MSPEED=0.99;
    @Override
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            setMotors(gamepad1.left_stick_x,gamepad1.left_stick_y, gamepad1.right_stick_y, boost);
