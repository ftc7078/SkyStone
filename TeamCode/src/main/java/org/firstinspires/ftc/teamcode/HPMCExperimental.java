...
public class HPMCExperimental {
    ...
    public HPMCExperimental(DcMotorEx setMotor) {
        motor = setMotor;
    }

    public HPMCExperimental(HardwareMap hardwareMap, String motorString, double maxSpeedIn) {
    ...
    public HPMCExperimental(DcMotorEx setMotor, double maxSpeedIn) {
        motor = setMotor;
        maxSpeed = maxSpeedIn;
    }
